...
- **BMKG Open Data**
  - Gempa Bumi
  - CAP (Peringatan Dini Cuaca)
- **AI API (Alibaba Cloud Function + LLM)**
- **YouTube Embed**
...
3. Jalankan pada emulator atau perangkat Android
4. Pastikan koneksi internet aktif untuk data BMKG & AI
...
## 👤 Pengembang
**Arif Juharza**  
(IDCamp 2025 Developer Challenge)
