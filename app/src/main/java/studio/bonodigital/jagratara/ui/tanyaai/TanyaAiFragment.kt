package studio.bonodigital.jagratara.ui.tanyaai
...
import studio.bonodigital.jagratara.data.model.ChatMessage
import studio.bonodigital.jagratara.data.request.AskRequest
import studio.bonodigital.jagratara.databinding.FragmentTanyaAiBinding
import studio.bonodigital.jagratara.util.AiFormatter
import studio.bonodigital.jagratara.util.ChatStorage
        ...
        binding.btnSend.setOnClickListener {
            ...
            lifecycleScope.launch {
                try {
                    ...
                    val response = ApiClient.api.askJagratara(AskRequest(finalPrompt))
