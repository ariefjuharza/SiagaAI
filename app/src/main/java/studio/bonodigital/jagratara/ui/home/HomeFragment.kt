package studio.bonodigital.jagratara.ui.home
...
import studio.bonodigital.jagratara.api.ApiClient
import studio.bonodigital.jagratara.data.model.CapAlert
import studio.bonodigital.jagratara.data.model.ChecklistItem
import studio.bonodigital.jagratara.data.model.ChecklistUiItem
import studio.bonodigital.jagratara.databinding.FragmentHomeBinding
import studio.bonodigital.jagratara.repository.BmkgRepository
...
class HomeFragment : Fragment() {
    ...
    private fun loadChecklist() {
        val prefs = requireContext().getSharedPreferences("jagratara_prefs", Context.MODE_PRIVATE)
